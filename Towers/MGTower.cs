...
namespace TowerDefense
{
    public class MGTower : Tower
    {
        ...
        public MGTower(Texture2D tex, Vector2 pos, float scale) : base(tex, pos, scale)
        {
            Price = 15;
        ...
        private void FireProjectile(Vector2 direction)
        {
            ...
            _canFire = false;
            // Debug.WriteLine("Is this getting run?");
            var prj = new LightBullet(ResourceManager.GetTexture("Bullet_MG"), position, direction, _rotation, BulletSpeed, 0.3f);
        ...
        //    {
        //        BulletSpeed = 2f;
        //        texture = ResourceManager.GetTexture("MG2");
        //    }
        //    if (Level == 3)
        //    {
        //        BulletSpeed = 3f;
        //        texture = ResourceManager.GetTexture("MG3");
        //    }
        //}
    }
}
