...
namespace TowerDefense
{
    public class Game1 : Game
    {
        ...
        private string _textures = "circle,diamond,star,scoutCar,heavyCar,DollarSign,Bullet_Cannon,Bullet_MG,Cannon,Cannon2,Cannon3,car,transparentSquareBackground,MG,MG2,MG3,Missile,Missile_Launcher,Missile_Launcher2,Missile_Launcher3,police,road,Tower,yellow";
